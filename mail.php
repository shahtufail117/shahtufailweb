...
if ($name == "") {
    ...
    $headers .= 'From:  inbio <contact@shahtufail.com.np>' . "\r\n";
    $headers .= 'cc: contact@shahtufail.com.np' . "\r\n";
    $headers .= 'bcc: contact@shahtufail.com.np' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f contact@shahtufail.com.np');
